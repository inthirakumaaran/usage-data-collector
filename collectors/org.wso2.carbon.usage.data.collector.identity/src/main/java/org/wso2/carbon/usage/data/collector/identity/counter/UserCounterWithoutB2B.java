...
/**
 * Counter to calculate total users in the non b2b system.
 */
public class UserCounterWithoutB2B {

    private static final Log LOG = LogFactory.getLog(UserCounterWithoutB2B.class);
    ...
    public UserCounterWithoutB2B(RealmService realmService) {
